                ...
                <form action="expert/injury/addinjury" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="dynamicStep">
                        <div  class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Hướng dẫn bước 1</label> <input type="checkbox" name="">Gọi 115
                            ...
                            <div class="col-md-2">
                                <div>
                                    ...
                                    <input type="file" name="image_step1">
                                </div>
                                <div>
                                    <label>Âm thanh</label>
                                    <input type="file" name="audio_step1">
                                </div>
                            </div>
                        </div>
                    </div> 
...
<script type="text/javascript">
    ...
    function addInput(divName){
        if (counter == limit)  {
            ...
            "<div>" +
            "<label>Hình ảnh</label>" +
            "<input type='file' name='" + image_step+ "'>" +
            "</div>" +
            "</div>" +
            "<div class='col-md-3'>" +
            "<div>" +
            "<label>Âm thanh</label>" +
            "<input type='file' name='" + audio_step+ "'>" +
            "</div>" +
            "</div>" +
            "</div>";
                // 
